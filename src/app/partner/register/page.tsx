            ...
            <Card className="max-w-md w-full bg-[#0a111a] border-cyan-900/50">
                <form onSubmit={handleSubmit}>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Input placeholder="Nom du Club" required value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="bg-black/50 text-white border-gray-700"/>
                        <Input placeholder="Numéro IDE" required value={formData.ide} onChange={e => setFormData({...formData, ide: e.target.value})} className="bg-black/50 text-white border-gray-700"/>
                        <Input type="email" placeholder="Email Pro" required value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="bg-black/50 text-white border-gray-700"/>
                        <Input type="password" placeholder="Mot de passe" required value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} className="bg-black/50 text-white border-gray-700"/>
                        <Input type="password" placeholder="Confirmer" required value={formData.confirm} onChange={e => setFormData({...formData, confirm: e.target.value})} className="bg-black/50 text-white border-gray-700"/>
